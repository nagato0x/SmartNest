...
const facilityOptions = [
  { id: "cleanSafe", label: "Clean and Safe Environment", icon: "🧼" },
  { id: "furnishedRoom", label: "Furnished Room", icon: "🛏️" },
  { id: "wifi", label: "Wi-Fi / Internet", icon: "📶" },
  { id: "studyArea", label: "Study Area", icon: "📚" },
  { id: "attachedBathroom", label: "Attached Bathroom", icon: "🛁" },
  { id: "commonKitchen", label: "Common Kitchen", icon: "🍽️" },
  { id: "laundry", label: "Laundry Facilities", icon: "🧺" },
  { id: "parking", label: "Parking Space", icon: "🚗" },
  { id: "separateKitchen", label: "Separate Kitchen Area", icon: "🍳" },
  { id: "security", label: "Security (CCTV cameras)", icon: "📹" },
];
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="1 adults, 1 children">3 adults </option>
              <option value="2 adults, 1 children">4 adults </option>
              <option value="2 adults, 2 children">5 adults </option>
              <option value="3 adults, 0 children">6 adults</option>
              <option value="4 adults, 0 children">7 adults</option>
            </select>
