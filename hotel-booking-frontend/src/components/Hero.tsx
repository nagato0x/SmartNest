import { Search, MapPin, Calendar, Users, BookOpen } from "lucide-react";
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 pt-8 pb-8 relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 leading-relaxed">
            Discover safe and affordable student accommodations near your university.
            <br className="hidden md:block" />
            Search, compare, and book your ideal boarding with ease.
          </p>
          ...
          <div className="flex justify-center items-center space-x-8 mb-12">
            ...
            <div className="flex items-center text-white/80">
              ...
              <span className="text-sm font-medium">Near Universities</span>
            </div>
            <div className="flex items-center text-white/80">
              <Calendar className="w-5 h-5 mr-2" />
              <span className="text-sm font-medium">Flexible Lease</span>
            </div>
            <div className="flex items-center text-white/80">
